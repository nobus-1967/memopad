...
def get_rowid() -> int:
    ...
    try:
        ...
        rowid: int = int(
            prompt(
                ANSI("\033[31;1m(\033[0m" "\033[34;1mID\033[0m" "\033[31;1m)\033[0m ")
            )
        )
        if rowid <= 0:
            raise ValueError
...
def get_text_to_edit() -> str:
    ...
    text_to_edit: str = prompt("", multiline=True, clipboard=PyperclipClipboard())
...
def get_text_to_search() -> str:
    ...
    text_to_search: str = prompt(
        ANSI("\033[31;1m(\033[0m" "\033[34;1mТекст\033[0m" "\033[31;1m)\033[0m ")
    )
