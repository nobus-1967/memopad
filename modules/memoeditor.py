...
from modules.prompter import get_new_title, get_new_text, get_new_tag
from modules.prompter import get_title_to_edit, get_text_to_edit
from modules.prompter import get_tag_to_edit
